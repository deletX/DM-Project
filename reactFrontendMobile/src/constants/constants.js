...
export const status = ['Joinable', 'Computing', 'Computed'];

export const landingpageback = serverURL + 'media/landingpageback.jpg';

export const landingpageProfile = (num) =>
    serverURL + `media/profile_pictures/mock${num}.jpg`;
export const landingpageEvent = (num) =>
    serverURL + `media/event_pictures/mock${num}.jpg`;
