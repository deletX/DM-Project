    ...
    return async (dispatch) => {
        return axios
            ...
            .then(res => {
                ...
                AsyncStorage.multiSet([["access_token", access_token], ["refresh_token", refresh_token], ["expiration_date", expirationDate]]);
...
export const authCheckState = () => {
    return async dispatch => {
        ...
        if (token !== undefined || token !== null) {
            const expirationDate = new Date(AsyncStorage.getItem("expiration_date"));
