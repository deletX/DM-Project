...
ALLOWED_HOSTS = [
    "localhost", "127.0.0.1", "192.168.1.54", "192.168.1.27", "thechiosco.ns0.it",
...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = 'google_auth_secret'
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = 'app_oauth2_super_secret'
